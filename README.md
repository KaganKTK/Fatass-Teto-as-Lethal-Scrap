...
## Installation
Make sure you have **BepInEx** and **LethalLib** installed first.

1. Download and extract the mod zip.
2. Drop **both** `TetoMod.dll` and `teto.bundle` directly into your `Lethal Company/BepInEx/plugins` folder.
